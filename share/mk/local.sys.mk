...
PREFIX_LINKING=	Linking # Space for aligninment (does not work)
PREFIX_PROG=	${PREFIX_LINKING}
PREFIX_${PROG}=	${PREFIX_PROG}
PREFIX_${PROG_FULL}= ${PREFIX_PROG}
PREFIX_SHLIB=	${PREFIX_SHLIB}
PREFIX_${SHLIB_NAME_FULL}=	${PREFIX_SHLIB}
.MAKE.META.PREFIX=	${PREFIX_${.TARGET}:UBuilding} ${.TARGET:H:tA}/${.TARGET:T}
