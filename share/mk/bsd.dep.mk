...
_STD_DEPS_SHLIB=  ${LIBSCRT1} ${LIBCRTBEGINS} ${LIBGCC_S}    ${LIBCOMPILER_RT}   ${LIBCRTENDS} ${_STD_DEPS}
_STD_DEPS_STATIC= ${LIBCRT1}  ${LIBCRTBEGINT} ${LIBGCC_EH}   ${LIBCOMPILER_RT}   ${LIBCRTEND}  ${_STD_DEPS}
_STD_DEPS_PROFLIB=${LIBGCRT1} ${LIBCRTBEGINS} ${LIBGCC_EH_P} ${LIBCOMPILER_RT_P} ${LIBCRTENDS} ${_STD_DEPS}
_STD_DEPS_PROG=   ${LIBCRT1}  ${LIBCRTBEGIN}  ${LIBGCC_S}    ${LIBCOMPILER_RT}   ${LIBCRTEND}  ${_STD_DEPS}
