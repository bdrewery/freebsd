...
# XXX: Likely can move some of this to bsd.sys.mk now.
DISTRIBUTION?=	base
...
# calling 'make ${target}'. XXX: Move to incs/confs/files
...
# 'install'.
.if make(${__target}) || make(par-${__target})
par-${__target}: .PHONY ${__target}
