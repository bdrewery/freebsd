...
LIBCRT1?=	${DESTDIR}${LIBDIR}/crt1.o
LIBGCRT1?=	${DESTDIR}${LIBDIR}/gcrt1.o
LIBSCRT1?=	${DESTDIR}${LIBDIR}/Scrt1.o
LIBCRTI?=	${DESTDIR}${LIBDIR}/crti.o
LIBCRTBEGIN?=	${DESTDIR}${LIBDIR}/crtbegin.o
LIBCRTBEGINS?=	${DESTDIR}${LIBDIR}/crtbeginS.o
LIBCRTBEGINT?=	${DESTDIR}${LIBDIR}/crtbeginT.o
LIBCRTEND?=	${DESTDIR}${LIBDIR}/crtend.o
LIBCRTENDS?=	${DESTDIR}${LIBDIR}/crtendS.o
LIBCRTN?=	${DESTDIR}${LIBDIR}/crtn.o
...
LIBC_NONSHARED?=${DESTDIR}${LIBDIR}/libc_nonshared.a
...
LIBCOMPILER_RT_P?=${DESTDIR}${LIBDIR}/libcompiler_rt_p.a
...
LIBGCC_EH?=	${DESTDIR}${LIBDIR}/libgcc_eh.a
LIBGCC_EH_P?=	${DESTDIR}${LIBDIR}/libgcc_eh_p.a
LIBGCC_S?=	${DESTDIR}${LIBDIR}/libgcc_s.so
